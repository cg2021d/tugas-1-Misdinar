//class untuk menampilkan gambar dilayar
...
export default class Scene {
    ...
    constructor(domElement) {
        ...
        if (this.context === null) {
            alert("Browser tidak kompatibel dengan WebGL");
            return;
        }
    ...
    //value di gl_position bukan 1, karena menyesuaikan gambar yang kebesaran
    _createVertexShader() {
        let vertexShaderCode = `
            ...
            varying vec4 vColor;
            void main(){
                gl_Position = vec4(aCoordinates, 1.4);
                vColor = aColor;
            }`
